var s_tc_RichmondTimesContainer=new TagContainer('RichmondTimesContainer');
...
s.linkInternalFilters="javascript:,timesdispatch.com"
...
//Get previous page value
	s.prop10=s.getPreviousValue(s.pageName,'gpv_pn','event3');
	s.eVar7=s.prop10;	

// Page URL excluding Query Strings
	s.prop13=location.protocol + "//" + location.host + location.pathname
	s.eVar6=s.prop13;
...
// getTimeParting without year check
	s.prop7=s.eVar3=s.getTimeParting('h','-6'); // Set hour 
	s.prop8=s.eVar4=s.getTimeParting('d','-6'); // Set day 
	s.prop9=s.eVar5=s.getTimeParting('w','-6'); // Set weekday
...
// copy s.props to eVars
	...
	if(s.prop19 && s.prop19!=""){
		s.prop19=s.prop19.toLowerCase();
		s.eVar24='D=c19';
	}	
	if(s.prop11 && s.prop11!=""){
...
s.visitorNamespace = "richmondtimesdispatch"
s.trackingServer = "richmondtimesdispatch.d1.sc.omtrdc.net"

s.setTagContainer("RichmondTimesContainer")
